...
backend web1 { .host = "127.0.0.1"; .port = "7080"; } 
backend web2 { .host = "127.0.0.1"; .port = "7081"; } 
...
# Use anonymous, cached pages if all backends are down.
  ...
  if (req.http.Cookie) {
    ...
    # Concrete 5 cookie support
    set req.http.Cookie = regsuball(req.http.Cookie, ";(CONCRETE5)=", "; \1=");
    set req.http.Cookie = regsuball(req.http.Cookie, ";[^ ][^;]*", "");
    set req.http.Cookie = regsuball(req.http.Cookie, "^[; ]+|[; ]+$", "");
...
# Serves separate caches for http and https requests
